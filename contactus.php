...
<nav class="navbar navbar-dark navbar-expand  fixed-top">
        <div class="container " style="margin-left:0px">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item" ><a class="nav-link active" href="contactus.php"><span class="fa fa-address-card fa-lg"></span>Contact</a></li>
           ...
           <div class="col-12">
            ...
            <div class="col-12 col-sm-4 offset-sm-1">
                   <h5>Our Address</h5>
                    ...
                    121, Anil Neerukonda hospital Road<br>
		              ...
		              Visakhapatnam<br>
		              <i class="fa fa-phone"></i>: 08933-225083<br>
		              <i class="fa fa-fax"></i>: 08933-225083<br>
		              <i class="fa fa-envelope"></i>:
                        <a href="mailto:principal@anits.edu.in">principal@anits.edu.in</a>
		           </address>
            </div>
            ...
            <div class="col-12 col-sm-11 offset-sm-1">
                <div class="btn-group" role="group">
                    <a class="btn btn-primary" role="button" href="tel:+916303773348"><i class="fa fa-phone"></i>Call</a>
                    <a class="btn btn-info" role="button" ><i class="fa fa-skype"></i>Skype</a>
                    <a class="btn btn-success" role="button" href="mailto:confusion@food.net"><i class="fa fa-envelope-o"></i></a>
                </div>
            </div>
        </div>
            ...
            <div class="col-12 col-md-9">
                <form>
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input style="padding:15px" type="text" class="form-control" id="firstname" name="firstname" placeholder="First name">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="lastname" class="col-md-2 col-form-label">Last Name</label>
                        <div class="col-md-10">
                            <input style="padding:15px" type="text" class="form-control" id="lastname" name="lastname" placeholder="Last name">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="telnum" class="col-12 col-md-2 col-form-label">Contact tel.</label>
                        <div class="col-5 col-md-3">
                            <input style="padding:15px" type="tel" class="form-control" id="areacode" name="areacode" placeholder="Area Code">
                        </div>
                        <div class="col-7 col-md-7">
                            <input style="padding:15px" type="tel" class="form-control" id="telnum" name="telnum" placeholder="Tel. Number">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="emailid" class="col-md-2 col-form-label">Email</label>
                        <div class="col-md-10">
                            <input style="padding:15px" type="email" class="form-control" id="emailid" name="emailid" placeholder="Email">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-6 offset-md-2">
                            <div class="form-check">
                                <input style="padding:15px" type="checkbox" class="form-check-input" name="approve" if="approve" value="">
