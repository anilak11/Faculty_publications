<?php 
    ...
    //echo $username;
    $user_check_query = "SELECT * FROM faculty2021 where yop='2017'";
    if(isset($_POST['btnsearch']))
    {
        $jrnlname=$_POST['search2022'];
        $user_check_query = "SELECT * FROM faculty2021 where jrnlname='$jrnlname' and yop='2017'";
    }
    else
    $user_check_query = "SELECT * FROM faculty2021 where yop='2017'";
...
<body style="font-size:13px">
    ...
    <div class="row row-con" style="margin-top:80px;margin-left:80%">
        <div class="col-4 col-sm-2">
            <form method="post" action="allj2022.php">
                <input type="search" placeholder="search by Name of the Journal" name="search2022" id="search2022">
                <button type="submit" class="btn btn-primary btn-sm" name="btnsearch">Search</button>
            </form>
        </div>
    </div>
    <div class="row row-content" style="margin-left:100px;">
