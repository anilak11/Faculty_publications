...
<body style="background-image: url('images/backy99.jpeg');">
    <nav class="navbar navbar-dark navbar-expand  fixed-top" style="font-size:90%">
        <div class="container " style="margin-left:0px">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item" style="margin-left:700px"><a class="nav-link" href="adminlogin.php"><span class="fa fa-sign-in fa-lg"></span>ADMIN Login</a></li>
  ...
  <form method="post" action="login.php" autocomplete="off">
    ...
    <p>
  		Forgot Password ? <a href="fpassword.php">Click Here</a>
  	</p>
  	<div class="input-group">
