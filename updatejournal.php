...
<body style="font-size:13px;background-color:black;background-image: url('images/backy4.jpg');">
    ...
    <div class="row row-content">
           <div class="col-12">
              <h3 style="color:white;margin-left:35%">UPDATE JOURNAL</h3>
           </div>
            <div class="col-12 col-md-9">
                <form method="post" action="updatejournal.php" autocomplete="off">
                ...
                <?php  endif ?>
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input style="padding:15px" type="text" class="form-control" id="jidinsert" name="jidinsert"  value="<?php echo $_SESSION['facultyid']?>" placeholder="Enter Journal Id to Update" required >
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="titleinsert" class="col-md-2 col-form-label" style="color:white;">Title of the Paper</label>
                        <div class="col-md-10">
                            <input style="padding:15px" type="text" class="form-control" id="titleinsert" name="titleinsert" placeholder="New Title of the Paper" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="anameinsert" class="col-md-2 col-form-label" style="color:white;"> Name of the Author</label>
                        <div class="col-md-10">
                            <input style="padding:15px" type="text" class="form-control" id="anameinsert" name="anameinsert" placeholder="New Name of the Author" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input style="padding:15px" type="text" class="form-control" id="jnameinsert" name="jnameinsert" placeholder="New Name of the Journal" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input style="padding:15px" type="date" class="form-control" id="dopinsert" name="dopinsert" placeholder="New Date Of Publication" min="2020-01-01" max="2050-12-31" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input style="padding:15px" type="text" class="form-control" id="issninsert" name="issninsert" placeholder="Enter Updated ISSN Number" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="fileinsert" class="col-md-2 col-form-label" style="color:white;"> Link to the Journal</label>
                        <div class="col-md-10">
                            <input  style="padding:15px" type="url" class="form-control" id="fileinsert" name="fileinsert"  required placeholder="Enter/paste the Updated URL here">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="offset-md-2 col-md-10">
                            <button type="submit" class="btn btn-success btn-lg " name="btnupdate">
                                UPDATE
                            </button>
                        </div>
                    </div>
