...
<body style="font-size:13px;background-image: url('images/backy2.jpg');">
    <nav class="navbar navbar-dark navbar-expand  fixed-top">
        <div class="container " style="margin-left:0px">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item" style="margin-left:700px"><a class="nav-link" href="index.php"><span class="fa fa-sign-out fa-lg"></span>Log out</a></li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container" style="background-color:">
       <h4 style="color:white">WELCOME BACK <?php echo $_SESSION['adid']; ?></h4>
       <div class="row row-content" style="min-height:100px">
           <div class="col-12 col-sm-6">
           <a class="nav-link btn btn-primary" href="addjournal.php" style="margin-left:80px"><span class="fa fa-plus fa-lg"></span>ADD Faculty</a><br>
           <a class="nav-link btn btn-success" href="viewjournals.php" style="margin-top:80px;margin-left:60%;"><span class="fa fa-eye fa-lg"></span>VIEW JOURNALS</a>
           </div>
           <div class="col-12 col-sm-6">
           <a class="nav-link btn btn-danger" href="deljournal.php"><span class="fa fa-trash fa-lg"></span>DELETE FACULTY</a><br>
           </div>
       </div>
    </div>
