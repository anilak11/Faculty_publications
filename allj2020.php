<?php 
    ...
    //echo $username;
    $user_check_query = "SELECT * FROM faculty2021 where yop='2020'";
    if(isset($_POST['btnsearch']))
    {
        $jrnlname=$_POST['search2022'];
        $user_check_query = "SELECT * FROM faculty2021 where jrnlname='$jrnlname' and yop='2020'";
    }
    else
    $user_check_query = "SELECT * FROM faculty2021 where yop='2020'";
...
<body style="font-size:13px">
    ...
    <div class="row row-con" style="margin-top:80px;margin-left:80%">
        <div class="col-4 col-sm-2">
            <form method="post" action="allj2020.php">
